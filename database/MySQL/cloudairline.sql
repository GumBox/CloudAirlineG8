...
--
-- Host: localhost    Database: cloudairline
-- ------------------------------------------------------
...
CREATE TABLE `booking` (
  ...
  KEY `planeId` (`planeId`),
  CONSTRAINT `booking_ibfk_1` FOREIGN KEY (`ticketId`) REFERENCES `ticket` (`ticketId`),
  CONSTRAINT `booking_ibfk_2` FOREIGN KEY (`planeId`) REFERENCES `plane` (`planeId`),
...
CREATE TABLE `ticket` (
  ...
  `ticketType` tinyint(1) DEFAULT '0',
  `ticketBuyingDate` date DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  `userGender` tinyint(1) DEFAULT '0',
...
-- Dump completed on 2022-08-12 12:01:40
