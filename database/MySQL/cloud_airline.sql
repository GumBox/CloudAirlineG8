...
--
-- Host: localhost    Database: cloud_airline
-- ------------------------------------------------------
...
CREATE TABLE `ticket` (
  ...
  `ticket_buying_date` date DEFAULT NULL,
  ...
  CONSTRAINT `ticket_ibfk_1` FOREIGN KEY (`plane_id`) REFERENCES `plane` (`plane_id`),
  CONSTRAINT `ticket_ibfk_2` FOREIGN KEY (`receipt_id`) REFERENCES `receipt` (`receipt_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
